...
contract QuantSafuProtocol is ERC20Detailed, Ownable {
    ...
    string public _name = "QuantSAFU Protocol";
    ...
    uint256 public qusBankFee = 20;
    uint256 public nftHolderFee = 20;

    uint256 public sellFee = qusBankFee.add(nftHolderFee);
    ...
    address public qusBankReceiver;
    ...
    constructor() ERC20Detailed("QuantSAFU Protocol", "QUS", uint8(DECIMALS)) Ownable() {
        ...
        treasuryReceiver = 0x2d700E0B13C3e2Da2271767Ad4462e4883E43bE2;
        insuranceReceiver = 0x8f81422a08f0307c43d202103fF32488566A2F5B;
        qusBankReceiver = 0x4C2ec068c7c8F71CA571C54cca4200b97D719143;
        nftHolderReceiver = 0x521301B271Fd624009043061544039ae4B88a563;
    ...
    function setNormalFees() external onlyOwner {
        ...
        sellFee = qusBankFee.add(nftHolderFee);
    ...
    function swapBack() internal swapping {
        ...
        uint256 _currentFee = treasuryFee.add(insuranceFee).add(qusBankFee).add(nftHolderFee);
        ...
        (success, ) = payable(qusBankReceiver).call{
        value: currentBalance.mul(qusBankFee).div(
            _currentFee
        ),
        gas: 30000
        }("");
